...
<body>
    <div class="content">
        <div class="logbook-container">
            <h2>Your Logbooks</h2>
            <p class="logbook-created-time"  style="margin-bottom: 30px;">Upload your logbook here. Supported file types are .pdf, .doc, .docx. Maximum size is 2MB.</p>
            @if(session('success'))
            ...
            <ul>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text logbook-created-time">
                                    ...
                                    <button type="button" class="delete-logbook-button" data-toggle="modal" data-target="#confirmationModal-{{ $logbook->id }}">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('logbooks.destroy', $logbook) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                ...
                @endif
                <form action="/upload-logbook" method="POST" enctype="multipart/form-data" class="upload-logbook-form">
                    @csrf
