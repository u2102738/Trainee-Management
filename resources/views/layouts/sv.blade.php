...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/sv-homepage') }}">
                    {{ config('sv.name', 'TMS') }}
                </a>
            ...
            <div class="modal fade" id="notificationsModal" tabindex="-1" role="dialog" aria-labelledby="notificationsModalLabel" aria-hidden="true">
                ...
                <div class="custom-sidebar">
                  ...
                  <div class="menu">
                      ...
                      <a href="/sv-trainee-assign">
                          <div class="icon">
                            <img src="https://img.icons8.com/ios/50/batch-assign.png" alt="My Trainee Icon" class="w-6 h-6"/>
                          </div>
                          <div class="label">My Trainee</div>
                      </a>
              
                      <a href="/sv-profile">
                          <div class="icon">
                              <img src="https://img.icons8.com/ios/452/user--v1.png" alt="View Seat Plan Icon" class="w-6 h-6"/>
                          </div>
