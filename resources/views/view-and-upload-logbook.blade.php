...
@section('breadcrumbs', Breadcrumbs::render('admin-view-trainee-logbook', $name))
...
<head>
    ...
    <style>
        ...
        .logbook-card {
            flex: 0 0 calc(50%); /* Two cards per row with some spacing */
            margin-bottom: 20px;
            margin-left: -40px;
        }
    ...
    <div class="content">
        <div class="logbook-container">
            ...
            <ul>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('remove-logbooks.destroy', ['logbook' => $logbook, 'name' => $name]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                ...
                @endif
                <form action="{{ route('admin-upload-logbook', ['name' => $name]) }}" method="POST" enctype="multipart/form-data" class="upload-logbook-form">
                    @csrf
                    ...
                    <div class="logbook-info">
                        <label for="logbook" class="custom-file-upload" style="margin-right: 30px;">Choose Signed Logbook</label>
                        <span id="file-name" class="file-name" style="margin-top: 10px;">No file selected</span>
                    </div>
                    <button type="submit" class="upload-button" style="margin-top: 30px;">Upload Signed Logbook</button>
                </form>
